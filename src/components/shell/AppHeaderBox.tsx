        ...
        >
            {isDark ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 2a.75.75 0 01.75.75v1a.75.75 0 01-1.5 0v-1A.75.75 0 0110 2zM6.464 5.404a.75.75 0 010 1.06 4 4 0 105.657 5.657.75.75 0 011.06 1.06A5.5 5.5 0 116.464 5.404zM16.25 9.25a.75.75 0 010 1.5h1a.75.75 0 010-1.5h-1zM2.75 9.25a.75.75 0 000 1.5h1a.75.75 0 000-1.5h-1zM14.596 5.404a.75.75 0 011.06 0l.708.707a.75.75 0 01-1.061 1.06l-.707-.707a.75.75 0 010-1.06zM4.636 14.657l-.707.707a.75.75 0 101.06 1.06l.708-.707a.75.75 0 00-1.06-1.06zM10 16.25a.75.75 0 01.75.75v1a.75.75 0 01-1.5 0v-1a.75.75 0 01.75-.75z" clipRule="evenodd" />
                </svg>
            ) : (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4" aria-hidden="true">
